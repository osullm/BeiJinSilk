      ...
      for (int index1 = 0; index1 < length1; ++index1)
      {
        ...
        for (int index2 = 0; index2 < length2; ++index2)
        {
          ...
          for (int index3 = 0; index3 < length1; ++index3)
          {
            ...
            string[] strArray;
            IntPtr index4;
            (strArray = parameterOut)[(int) (index4 = (IntPtr) index2)] = strArray[index4] + array[index3].ToString() + ",";
          }
          numArray6[index2] = this.MinValue(array);
          string[] strArray1;
          IntPtr index5;
          (strArray1 = parameterOut)[(int) (index5 = (IntPtr) index2)] = strArray1[index5] + "    结果：" + numArray6[index2].ToString();
        }
      }
      return numArray6;
    }
